			...
			<div class="container container-sm container-md container-lg container-xl container-xxl">
				<div class="row">
					<div class="col-xxl-5 col-xl-6 col-lg-7 col-md-8 col-sm-12 text-center me-auto p-2">
						...
						<?php echo $setting_header->slider_title; ?>

						</h1>
						<p class="text-custom-danger my-3">
							<?php echo $setting_header->slider_description; ?>

						</p>
						<a href="<?php echo $setting_header->slider_link; ?>" class="btn btn-lg btn-custom-danger px-4 mt-3">
							<?php echo $setting_header->slider_button; ?>
...
</header><?php /**PATH /Users/saeed/Documents/project-cm/landiper/resources/views/layouts/site/blocks/header.blade.php ENDPATH**/ ?>