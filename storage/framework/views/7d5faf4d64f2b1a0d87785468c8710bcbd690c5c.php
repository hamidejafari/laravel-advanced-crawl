...
<div class="content">
	<div class="container-sm container-md container-lg container-xl container-xxl py-2">
		<div class="clearfix about-us px-3">
			<img src="<?php echo e(asset('assets/uploads/setting/'. $setting_header->aboutimg)); ?>"
				class="col-md-6 float-md-start mb-3 ms-md-3" alt="...">
			<h1 class="text-custom fw-bolder h3">
				درباره لندیپر
			</h1>
			<p>
				<?php echo $setting_header->aboutus; ?>
...
<?php echo $__env->make("layouts.site.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/saeed/Documents/project-cm/landiper/resources/views/site/aboutus.blade.php ENDPATH**/ ?>