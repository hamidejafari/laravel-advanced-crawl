...
<div class="border dashboard-search p-4 mb-0">
	<h4 class="text-custom mb-4 px-1 d-flex align-items-center justify-content-between">
		جزییات تیکت شماره <?php echo e($ticket->id); ?>

		<a class="btn btn-sm btn-custom-danger rounded-3 m-0" href="<?php echo e(url('/panel/tickets')); ?>">
			بازگشت
		...
		<div class="col-xxl-12 col-lg-12 col-sm-12 p-2">
			<div class="well-l chatroom">
				<div class="card card-chat rounded m-auto">
					<form action="<?php echo e(route('site.panel.ticket.reply')); ?>" method="post" class="m-0"
								...
								<div class="col-xxl-6 col-xl-7 col-lg-8 col-md-9 col-sm-10 col-xs-12 p-1 me-auto">
									<div class="bg-light max-cuntent right-chat shadow-sm" style="background:#eee">
										<h5 class="fw-bolder text-custom-danger">
											<?php echo e(@$ticket->user->name . ' ' . @$ticket->user->family); ?>

										</h5>
										<div class="text-secondary text-justify" style="white-space: pre-line;">
											<p class="m-0">
												<?php echo e($ticket->content); ?>

											</p>
										</div>
										<small class="text-secondary smal">
											<?php echo e(jdate('Y/m/d H:i',$ticket->created_at->timestamp)); ?>

										</small>
									</div>
								</div>
							</div>
							<?php $__currentLoopData = $ticket->replies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if($row->user_id == Auth::id()): ?>
							<div class="col-sm-12 p-2">
								<div class="col-xxl-6 col-xl-7 col-lg-8 col-md-9 col-sm-10 col-xs-12 p-1 me-auto">
									<div class="bg-light max-cuntent right-chat shadow-sm" style="background:#eee">
										<h5 class="fw-bolder text-custom-danger">
											<?php echo e(@$row->user->name . ' ' . @$row->user->family); ?>
						...
						<div class="position-absolute input-box">
							<div class="bg-white m-0 rounded-0 border" style="position: relative;">
								<input type="hidden" name="reply_id" value="<?php echo e($ticket->id); ?>" />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("site.panel.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/saeed/Documents/project-cm/landiper/resources/views/site/panel/ticket-detail.blade.php ENDPATH**/ ?>