...
<hr class="my-2">
	...
	<div class="form-floating mb-2">
		<input type="text" name="email" class="form-control bg-white shadow-sm"  placeholder="">
		<label  class="text-secondary">
...
<?php /**PATH /Users/saeed/Documents/project-cm/landiper/resources/views/site/contents/form-contact.blade.php ENDPATH**/ ?>