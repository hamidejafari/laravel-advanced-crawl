					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="navbarNav">
							<ul class="navbar-nav me-auto ul-meg">
											...
											<div class="tab-content" id="v-pills-tabContent">
												<div class="tab-pane fade show active" id="v-pills-home"
													...
													<div class="w-100 p-1">
														...
														<div class="row w-100 m-0">
                                                            <?php $__currentLoopData = $countries2->chunk(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    ...
                                                                    <ul class="px-0 m-0">
                                                                        <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <li class="list-unstyled py-1">
                                                                                <a href="<?php echo e(url('/'.$row->url)); ?>" class="text-decoration-none text-secondary">
                                                                                    <i class="fas fa-caret-left me-2"></i>
                                                                                     خرید رپورتاژ از سایت های کشور <?php echo e($row->title); ?>
												...
												<div class="tab-pane fade" id="v-pills-profile"
													...
													<div class="w-100 p-1">
														...
														<hr class="my-2">
														<div class="row w-100 m-0">
															<?php $__currentLoopData = $languages2->chunk(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="col-md-4 p-1">
                                                                    <ul class="px-0 m-0">
                                                                        <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <li class="list-unstyled py-1">
                                                                                <a href="<?php echo e(url('/'.$row->url)); ?>" class="text-decoration-none text-secondary">
                                                                                    <i class="fas fa-caret-left me-2"></i>
                                                                                    خرید رپورتاژ  <?php echo e($row->title); ?>
                                ...
                                <!--            <hr class="my-2">-->
                                <!--            <div class="row w-100 m-0">-->
                                <!--                <?php $__currentLoopData = $service2->chunk(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>-->
                                <!--                    <div class="col-md-4 p-1">-->
                                <!--                        <ul class="px-0 m-0">-->
                                <!--                            <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>-->
                                <!--                                <li class="list-unstyled py-1">-->
                                <!--                                    <a href="<?php echo e('/service/'. $row->url); ?>" class="text-decoration-none text-secondary">-->
                                <!--                                        <i class="fas fa-caret-left me-2"></i>-->
                                ...
                                <li class="nav-item">
									<a class="nav-link text-custom fw-bold a-dr" href="<?php echo e(url('/contact-us')); ?>">
										تماس با ما
									</a>
								</li>
								<li class="nav-item">
									<a class="nav-link text-custom fw-bold a-dr" href="<?php echo e(url('/about-us')); ?>">
										درباره ما
									</a>
								</li>
							</ul>
							...
							<ul class="navbar-nav auth-nav ms-auto">
                                ...
                                <?php if(!$user): ?>
                                   <li class="nav-item">
                                       <a class="nav-link text-custom fw-bold d-grid text-center" href="<?php echo e(url('/login2')); ?>">
                                   ...
                                   <li class="nav-item">
                                       <a class="nav-link text-custom fw-bold d-grid text-center" href="<?php echo e(url('/register2')); ?>">
                                ...
                                <?php else: ?>
                                   ...
                                   <li class="nav-item">
                                       <a class="nav-link text-custom fw-bold d-grid text-center" href="<?php echo e(route('site.panel.dashboard')); ?>">
                                           <i class="fas fa-user text-custom-danger"></i>
                                           <i class="bi bi-person text-custom-danger"></i>
                                           پنل کاربری
                                       </a>
                                   ...
                                   <li class="nav-item">
                                       <a class="nav-link text-custom fw-bold d-grid text-center" href="<?php echo e(route('site.panel.order.cart')); ?>">
	...
	<div class="menu bg-white h-auto shadow-sm">
		<div id="mySidenav" class="sidenav bg-custom">
			...
			<div class="dd">
								...
								<div id="collapseOne" class="accordion-collapse collapse show"
									...
									<div class="accordion-body bg-light">
										<ul class="px-0 m-0">
										    <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<li class="list-unstyled py-1">
												<a href="<?php echo e(url('/'.$row->url)); ?>" class="text-custom">
												    خرید رپورتاژ از سایت های کشور <?php echo e($row->title); ?>
				...
				<a href="<?php echo e(url('/about-us')); ?>" class="px-3 py-2">
					<i class="fas fa-info me-1"></i>
					درباره ما
				</a>
				<a href="<?php echo e(url('/contact-us')); ?>" class="px-3 py-2">
...
<?php /**PATH /Users/saeed/Documents/project-cm/landiper/resources/views/layouts/site/blocks/menu.blade.php ENDPATH**/ ?>