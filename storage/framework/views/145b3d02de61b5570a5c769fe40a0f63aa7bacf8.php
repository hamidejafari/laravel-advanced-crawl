...
<div class="sign d-flex align-items-center justify-content-center">
	<div class="col-xl-4 col-lg-5 col-md-6 col-sm-7 p-1 m-auto">
		<div class="card bg-light shadow p-4">
			<form action="<?php echo e(route('site.post-register')); ?>" method="POST" class="">
					...
					<div class="col-sm-6 p-1">
						<div class="form-floating">
							<input type="text" class="form-control text-start" id="floatingName" name="family"
								placeholder="....." value="<?php echo e(old('family')); ?>">
							<label for="floatingName" class="text-secondary">
								نام خانوادگی :
							</label>
						</div>
					...
					<div class="col-sm-12 p-1">
						<div class="form-floating">
							<input type="tel" class="form-control text-start" id="floatingTel" name="mobile"
								placeholder="....." value="<?php echo e(old('mobile')); ?>">
...
<?php echo $__env->make("layouts.site.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/saeed/Documents/project-cm/landiper/resources/views/site/auth/register.blade.php ENDPATH**/ ?>