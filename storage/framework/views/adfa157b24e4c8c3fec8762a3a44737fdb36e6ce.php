		...
		<div class="contactus px-3">
			<div class="row">
				<div class="col-lg-6 col-sm-12 border-end p-4">
					...
					<form class="form-floating m-0" method="post" action="/contactus/">
						<?php echo csrf_field(); ?>
						<?php echo $__env->make('site.contents.form-contact', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
					</form>
				</div>
				<div class="col-lg-6 col-sm-12 border-start social-c p-4">
					<?php echo $__env->make('site.contents.info-contact', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				</div>
...
<?php echo $__env->make("layouts.site.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/saeed/Documents/project-cm/landiper/resources/views/site/contactus.blade.php ENDPATH**/ ?>