...
@section('content')
            ...
            <form method="get" action="{{URL::current()}}" class="m-0">
                ...
                <div class="row w-100 m-0">
                    <div class="col-xxl-6 col-xl-6 col-lg-6 p-0">
                        <div class="row w-100 m-0">
                            <div class="col-xxl-4 col-lg-12 col-sm-6 p-1">
                                ...
                                <input type="number" name="da" id="" class="form-control"  placeholder="15" value="{{ $da ? $da : '' }}">
                            </div>
                            <div class="col-xxl-4 col-lg-12 col-sm-6 p-1">
                                <label for="" class="text-secondary d-flex align-items-center">
                                    حداقل DR
                                </label>
                                <input type="number" name="dr" id="" class="form-control"  placeholder="0" value="{{ $dr ? $dr : '' }}">
                            </div>
                            <div class="col-xxl-4 col-lg-12 col-sm-6 p-1">
                                <label for="" class="text-secondary d-flex align-items-center">
                                    حداکثر قیمت (تومان)
                    ...
                    <div class="col-xxl-3 col-lg-12 col-sm-4 p-1 text-center">
                        ...
                        <input type="text" name="domain" value="{{@$domain}}" id="" class="form-control"  placeholder="دامین"/>
                    </div>
                    <div class="col-xxl-3 col-lg-12 col-sm-4 p-1 text-center">
    ...
    @foreach($products as $row)
        ...
        <div class="modal fade" id="orderModal{{$row->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                ...
                @endphp
                @if(@$my_item)
                    <form method="post" action="{{route('shop-item-bank')}}" enctype="multipart/form-data" >
                        @else
                            <form method="post" action="{{route('site.panel.order.post-add')}}" enctype="multipart/form-data" >
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        @if($row->requirements !== null || $row->content_requirements !== null)
                                            <div class="mb-3">
                                                ...
                                                <div class="collapse show" id="collapseExample">
                                                    <div class="card card-body text-danger text-justify">
                                                        <p class="m-0">
                                                            ...
                                                            <br>
                                                            {{$row->content_requirements ? $row->content_requirements : ''}}
                                                ...
                                                <div class="col-xl-6 p-1">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input name="name" type="text" class="form-control"
                                                               placeholder=" نام کمپین را وارد کنید..." value="{{@$my_item->name}}">
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 p-1">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input name="title" type="text" class="form-control"
                                                               placeholder=" عنوان رپورتاژ را وارد کنید..." value="{{@$my_item->title}}">
                                                    </div>
                                                </div>
                                                <div class="col-xl-12 p-1">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="description" type="text" rows="3" cols="3"
                                                                  class="form-control"
                                                                  placeholder=" اگر توضیح و نکته ای در هنگام انتشار رپورتاژ دارید وارد نمایید.">{{@$my_item->description}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="">
                                                <p class="text-end m-0">
                                                    @if(@$my_item->file !== null)
                                                        <a href="{{asset('/assets/uploads/product/'.@$my_item->file)}}"
                                            ...
                                            <div class="row w-100 m-0">
                                                <div style="margin-right: 24%;margin-top: -1%;" class="col-xxl-6 col-lg-6 col-sm-12 p-2">
                                                    <div class="card bg-light rounded-3 shadow-sm p-2">
                                                        <ul class="px-0 m-0">
                                                            {{--                                            @if($row->price > @$my_item->product->price)--}}
                                                            ...
                                                            @if($row->price > Auth::user()->wallet)
                                                                <li class="list-unstyled p-1">
                                                                    <p class="m-0 text-custom fw-bolder">
                                                                        اعتبار شما :
                                                                        <span class="text-custom-danger fw-lighter float-end">
                                                                {{number_format(Auth::user()->wallet)}} تومان
                                                            </span>
                                                                    </p>
                                                                </li>
                                                                <li class="list-unstyled p-1">
                                                                    <p class="m-0 text-custom fw-bolder">
                                                                        مبلغ قابل پرداخت :
                                                                        <span class="text-custom-danger fw-lighter float-end">
                                                                {{number_format(($row->price) - Auth::user()->wallet)}} تومان
                                                            </span>
                                                                    </p>
                                                                </li>
                                                            ...
                                                            @endif
                                                            {{--                                            @elseif($row->price < @$my_item->product->price)--}}
                                                            {{--                                                <input name="type" value="4" type="hidden" />--}}
                                                            {{--                                                <li class="list-unstyled p-1">--}}
                                                            {{--                                                    <p class="m-0 text-custom fw-bolder">--}}
                                                            {{--                                                        مبلغ بازگشتی به کیف پول شما :--}}
                                                            {{--                                                        <span class="text-custom-danger fw-lighter float-end">--}}
                                                            {{--                                                                {{number_format(@$my_item->product->price - $row->price)}} تومان--}}
                                                            {{--                                                            </span>--}}
                                                            {{--                                                    </p>--}}
                                                            {{--                                                </li>--}}
                                                            {{--                                                <li class="list-unstyled p-1">--}}
                                                            {{--                                                    <button  type="submit" class="btn btn-custom-danger rounded-3 w-100">--}}
                                                            {{--                                                       بازگشت به کیف پول و تغییر رسانه--}}
                                                            {{--                                                    </button>--}}
                                                            {{--                                                </li>--}}
                                                            {{--                                            @elseif($row->price == @$my_item->product->price)--}}
                                    ...
                                    @php $user_cart_check = \App\Models\Order::where('user_id',Auth::id())->whereHas('orderItems')->count(); @endphp
                                    <div class="px-3 pb-3">
                                        <div class="form-check d-flex align-items-center justify-content-center p-0">
                                            <!-- Button trigger modal -->
                                        <!-- <button type="button" id="myBtn{{$row->id}}" class="btn border border-secondary rounded-3 w-100 d-flex align-items-center justify-content-center">
                                                    <h4 class="fw-bolder m-0">
                                                        ویدیو شرایط و قوانین استفاده از لندیپر
                                                    </h4>
                                                </button> -->
                                            <div class="border border-secondary rounded-3 w-100 d-flex align-items-center justify-content-center" style="padding: 1vh 1vh 1.5vh;" id="myBtn{{$row->id}}">
                                                @if(@$user_cart_check <= 0)
                                    ...
                                    <div id="myModal{{$row->id}}" class="modalsd">
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg px-5">
                                            <div class="modal-content">
                                            <!-- <div class="modal-header">
                                                    <span class="closesd{{$row->id}}" style="cursor: pointer;">&times;</span>
                                                </div> -->
                                                <div class="modal-body">
                                                    ...
                                                    <div class="border border-secondary rounded-3 w-100 d-flex align-items-center justify-content-center my-2 shadow-sm closesd{{$row->id}}" style="padding: 1vh 1vh 1.5vh;cursor: pointer;">
    ...
    <script>
        @foreach($products as $row)
        // Get the modal
        var modalsd{{$row->id}} = document.getElementById("myModal{{$row->id}}");

        var btn{{$row->id}} = document.getElementById("myBtn{{$row->id}}");

        var span{{$row->id}} = document.getElementsByClassName("closesd{{$row->id}}")[0];

        btn{{$row->id}}.onclick = function () {
            modalsd{{$row->id}}.style.display = "block";
        }

        span{{$row->id}}.onclick = function () {
            modalsd{{$row->id}}.style.display = "none";
        }

        window.onclick = function (event) {
            if (event.target == modalsd{{$row->id}}) {
                modalsd{{$row->id}}.style.display = "none";
            }
        }
        @endforeach
